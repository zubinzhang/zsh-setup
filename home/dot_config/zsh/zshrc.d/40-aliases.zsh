...
alias gbda='git branch --no-color --merged | command grep -vE "^(\*|\s*(master|stable*|develop|dev*)\s*$)" | command xargs -n 1 git branch -d'
alias gbdaf='git branch --no-color --merged | command grep -vE "^(\*|\s*(master|stable*|develop|dev*)\s*$)" | command xargs -n 1 git branch -D'
